...
parser.add_argument('-org', metavar='organism', type = str, nargs='+', default = None, 
...
if args.org:
    ds_df = ds_df[ds_df['organism'] == args.org] # filter for organism
else: 
    ds_df = ds_df[(ds_df['organism'] == 'mouse')]# | (ds_df['organism'] == 'mouse') | (ds_df['organism'] == 'rat') ] # filter for organism
if args.org_part:
